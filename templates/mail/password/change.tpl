...
{% block subject %}
Hola {{ first_name }}, cambiaste la contraseña OP+
{% endblock %}
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        ...
                                        OP+, a continuación encontraras una fracción de la nueva contraseña.
									</td>
								</tr>
								<tr>
									<td>
													...
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td style="padding: 0px 0 0 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                                                ...
                                                                el cambio de la contraseña por favor contacta a sistemas@asoandes.org.
															</td>
														</tr>
													</table>
												</td>
